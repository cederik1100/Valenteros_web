            ...
            <div class="max-w-md mx-auto bg-gray-900 rounded-lg shadow-lg p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <p class="text-xl mb-2 text-gray-300"><?= esc($user['email']) ?></p>
                    </div>
                </div>
                <div class="text-center mt-6">
                    <a href="<?= site_url('settings') ?>" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded">Edit Profile</a>
                </div>
            </div>
        </div>
    </div>
