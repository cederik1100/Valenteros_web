    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-8">
                    ...
                    <tbody class="text-gray-200 text-sm font-light">
                        <?php foreach ($tasks as $task): ?>
                            <tr class="border-b border-gray-200 hover:bg-gray-500">
                                ...
                                <td class="py-3 px-6">
                                    <a href="<?= site_url('pages/edit/' . esc($task['id'])) ?>"
                                        class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-1 px-3 mx-2 rounded">
                                        Edit
                                    </a>
                                    <form action="<?= site_url('pages/delete/' . esc($task['id'])) ?>" method="POST"
            ...
            <div class="mt-4 flex justify-center">
                <a href="<?= site_url('pages/create') ?>" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                    Add New Task
                </a>
            </div>
        </main>
